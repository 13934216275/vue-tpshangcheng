    ...
    <div class="dingdanlist">
        <el-card class="box-card">
            <el-tabs v-model="activeName">
                <div class="ding">
                    <el-button>待换货</el-button>
                    <el-button>已换货</el-button>
                </div>
                <div class="sou">
                    <el-date-picker
                            v-model="value2"
            ...
            <el-dialog title="查看订单" :visible.sync="dialogFormVisible" class="cc">
                <el-form :model="form">
                    ...
                    <el-form-item label="处理状态" :label-width="formLabelWidth" size="small">
                        <el-input v-model="form.zt" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="换货编号" :label-width="formLabelWidth" size="small">
                        <el-input v-model="form.je" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="申请时间" :label-width="formLabelWidth" size="small">
